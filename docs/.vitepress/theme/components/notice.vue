  ...
  <div v-if="visible" class="notice">
    ...
    <div class="notice-describe">
      ...
      <p class="notice-domain">
        <strong>
          详细教程：
          <a href="https://vitepress.yiov.top/layout.html#%E5%85%AC%E5%91%8A" target="_blank">wiki.seasir.top</a>
        </strong>
      </p>
      <p>QQ 频道：******(无效二维码)</p>
      <img class="notice-img" src="https://seasir.top/images/20cfd13d94cedaacabaf4acaf392eba.jpg" />
    </div>
